...
CSV_FILE = os.path.join(OUTPUT_FOLDER, "actionables_extracted_entities.csv")
...
# =====================
EXTRACTION_PROMPT = """
# Actionable Recommendations Extraction Prompt

**You are an expert biomedical text-mining system.  
Your sole task is to read the provided article and extract all *actionable recommendations* explicitly stated in the text.**

## Definition (for guidance only; do not hallucinate)
**Actionable Recommendations** are statements that clearly indicate:
- a suggested action,  
- a proposed intervention,  
- a recommended change,  
- a step to take,  
- or a practical guideline.
...
- research methods or future work that are *actionable*  

**Examples (do not include unless stated in the article):**
- “Increase physical activity to reduce risk…”  
- “Implement routine screening for…”  
- “Reduce exposure to…”  
- “Use X technique to improve Y…”  
- “Clinicians should consider…”  

## Instructions
- Read the article carefully.  
- Extract **only** recommendations that describe a concrete action to be taken.  
- Do **not** infer or rewrite; use the article’s wording.  
- Exclude statements that are:
  - purely descriptive  
  - background information  
  - non-actionable future research (“more studies are needed”)  
