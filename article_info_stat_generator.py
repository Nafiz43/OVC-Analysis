...
Reads a fixed CSV named "extracted_data.csv" and generates a single Excel file:
    entity_counts_all.xlsx

The Excel workbook will contain 5 sheets:
    - Proteins
    - Genes
    - DNA
    - RNA
...
Each sheet has two columns: Name, Occurrence.

Console output:
    - For each category: Unique count and total mentions
    - Final summary line with the number of UNIQUE items per category
"""
